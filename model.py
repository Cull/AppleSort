...
def letterbox_image(image, size):
    ...
    pil_im = image.resize((nw,nh), Image.BICUBIC)
    new_image = Image.new('RGB', size, (128,128,128))
    new_image.paste(pil_im, ((w-nw)//2, (h-nh)//2))
    return new_image
...
class YOLO(object):
	...
	def generate(self):
		...
		print("numclass " + str(num_classes))
